...
/**
 * Panda Options Pages Field
 *
 * @class   Panda_Options_Pages_Field
...
if ( ! class_exists( 'Panda_Options_Pages_Field' ) ) {
	
	class Panda_Options_Pages_Field extends Panda_Options_Field {
		...
		public function output() {
			...
			if ( ! isset( $field->posttype ) || ! post_type_exists( $field->posttype ) ) $field->posttype = 'page';
