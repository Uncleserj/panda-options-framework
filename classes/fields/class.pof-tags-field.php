...
/**
 * Panda Options Tags Field
 *
 * @class   Panda_Options_Tags_Field
...
if ( ! class_exists( 'Panda_Options_Tags_Field' ) && class_exists( 'Panda_Options_Taxonomy_Field' ) ) {
	
	class Panda_Options_Tags_Field extends Panda_Options_Taxonomy_Field {
